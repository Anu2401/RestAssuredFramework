...
public class PatchTc1 {
	...
	public static void orchestrator() throws IOException
		{    
			...
			for(int i=0 ; i<5 ; i++) 
	        {
			 responseStatuscode = CommonMethodApi.patchResponseStatuscodeExtractor(baseUri,resource,requestBody);	
			 
	          if (responseStatuscode == 200)
			  {
				responseBody = CommonMethodApi.patchResponseBodyExtractor(baseUri, resource, requestBody);
